...
def get_args():
    ...
    json_path = '/home/jhc/PycharmProjects/pythonProject/SORT_FAMILY/ByteTrack/datasets/mot/annotations/val_half.json'
    parser.add_argument('--json_path', type=str, default=json_path)

    mot17_root = '/home/jhc/Desktop/dataset/open_dataset/MOT/MOT17'
    parser.add_argument('--mot17_root', type=str, default=mot17_root)

    trackeval_gt_root = '/home/jhc/Desktop/dataset/open_dataset/MOT/data/gt/mot_challenge'
